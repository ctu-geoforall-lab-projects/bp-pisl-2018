...
There are two basic capabilities of a WPS server. It provides the
...
ZOO-project is an open source WPS platform that consists of several
...
As for the WPS invocation methods, it supports both synchronous and
