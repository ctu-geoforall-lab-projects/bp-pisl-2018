...
%% JP: doplneno
%% ML: WCS neni sluzba pro prohlizeni, ale stahovani dat (podobne jako WFS)
that points to a~running \zk{WFS} or \zk{WCS} (for only viewing data,
\zk{WMS}) service that will be retrieving data from the database.  The
